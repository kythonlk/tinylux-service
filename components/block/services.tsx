...
import st1 from "@/assets/images/st4.jpeg";
import st2 from "@/assets/images/st2.jpeg";
import st3 from "@/assets/images/st8.jpeg";
      ...
      <section className="w-full py-12 md:py-24 bg-gray-100 dark:bg-gray-800">
        <div className="flex flex-col items-center justify-center space-y-4 px-4  md:px-6">
          <div className="space-y-2 text-center">
            ...
            <p className="mx-auto px-4 md:px-20 text-gray-500 md:text-xl/relaxed lg:text-xl/relaxed pt-4 dark:text-gray-400">
              Prioritize your childrens safety with our eco-friendly baby gear
              services, including cleaning, repairs, and rentals. Get expert
              care for strollers and car seats, all designed for your
              convenience and peace of mind.
            </p>
          </div>
          <div className="grid px-4 md:px-16 w-full grid-cols-1 gap-6 md:grid-cols-3 md:gap-4 md:pt-10 lg:gap-8">
            {services.map((project, index) => (
              ...
              >
                <Image
                  ...
                  width="600"
                />
                <h3 className="text-xl font-semibold px-4 py-4  text-center  transition-all">
                  {project.title}
                </h3>
                <hr className="border-gray-300  bg-blue-700 rounded-full  w-3/4 m-auto pb-1" />
